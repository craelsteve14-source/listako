                ...
                {(paymentMethod === "gcash" || paymentMethod === "maya") && (
                  <div className="mb-4 border-2 border-red-200 rounded-2xl p-4 bg-red-50">
                    ...
                    <input
                      ...
                      placeholder={`Enter ${paymentMethod === "gcash" ? "GCash" : "Maya"} reference number...`}
                      className="w-full border border-red-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-400 bg-white font-mono"
                    />
                    <p className="text-xs text-red-500 font-medium mt-2">
                      ℹ️ Check the {paymentMethod === "gcash" ? "GCash" : "Maya"} SMS or notification for the reference number. Transaction cannot proceed without this.
                    </p>
                  </div>
                )}
